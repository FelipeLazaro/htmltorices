...
<table border="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  <tr>
    ...
    <br>
    </font><font color="#000066">Selecciona tu el Curso al que deseas ingresar:</font><font color="#000066"><form action="initial.php">

<p align="center">

<select name="D1">
<optgroup label="SISTEMA INSTITUCIONAL">
<option>Planeamiento Estratégico</option>
<option>Administración y organización</option>
<option>Cultura Organizacional</option>
<option>Gestión del Cambio</option>
</optgroup>
<optgroup label="IMAGEN INSTITUCIONAL">
<option>Relaciones Humanas</option>
<option>Relaciones Públicas</option>
<option>Administración de Valores</option>
<option>Mejoramiento del Clima Laboral</option>
</optgroup>
</select>
