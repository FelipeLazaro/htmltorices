...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="86%" id="AutoNumber1">
  <tr>
	...
	</font><font face="Times New Roman" size="6" color="#000066">Estimad<? echo $usrwellcome; ?>&nbsp; 
	estos sin tus últimos resultados de examen<br> 
    </font><font color="#000066">
	<br>
	<img border="0" src="res.png" width="558" height="833"></font></p></td>
  </tr>
</table>
