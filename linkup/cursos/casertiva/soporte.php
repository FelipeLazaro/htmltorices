  ...
  <tr>
	...
	<table border="0" cellSpacing="0" cellPadding="0" width="87%" align="center">
		<tr>
			...
			<font color="#FF3300">SOPORTE </font><span style="color: black">&nbsp; </span></p>
			<p class="MsoNormal" style="text-align:justify;line-height:150%">
			<b>Nota:</b><span style="font-style: normal; font-variant: normal; font-weight: normal; font-size: 7.0pt; font-family: Times New Roman">&nbsp;</span><span style="font-style: normal; font-variant: normal; font-weight: normal; "> </span>
			<span style="font-size: 11.0pt; line-height: 115%; font-family: Calibri,sans-serif">
			En esta sección podrás preguntar dudas acerca de cómo funciona el 
			...
			participantes tengan acceso.</span></p>
			<p class="MsoNormal" style="text-align: justify; line-height: 150%">&nbsp;</p>
			<table border="1" width="100%">
				<tr>
					<td><font color="#FF3300">PREGUNTAR AL ADMINISTRADOR DEL 
					SITIO</font></td>
				</tr>
				<tr>
					<td>
					<p align="center">A continuación escribe tu duda al 
					administrador Web en el siguiente recuadro, en cuanto termines da 
					clic en el botón enviar.</p>
