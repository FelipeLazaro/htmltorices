  ...
  <tr>
	...
	<table border="0" cellSpacing="0" cellPadding="0" width="87%" align="center">
		<tr>
			...
			<font color="#FF3300">TABLA DE POSICIONES </font><span style="color: black">&nbsp; </span></p>
			<p class="MsoNormal" style="text-align:justify;line-height:150%">
			<b>Nota: Esta sección muestra los puntos de cada participante 
			divididos en dos, puntos de canje y puntos de ranking totales.</b></p>
			<table border="1" width="100%">
				<tr>
					<td width="98%"><font color="#FF3300">Nombre del 
					participante&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Puntos de ranking&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Puntos de canje</font><br>
					<br>
&nbsp;</td>
				</tr>
				</table>
