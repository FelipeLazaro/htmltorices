  ...
  <tr>
	...
	<table border="0" cellSpacing="0" cellPadding="0" width="87%" align="center">
		<tr>
			...
			<font color="#FF3300">RETO 4&nbsp; (10/05/2011)</font></p>
			<p class="MsoNormal" style="text-align:center;line-height:150%">
			&nbsp;</p>
			<p class="MsoNormal" style="text-align:center;line-height:150%">
			<b>No habilitado: </b>Lo sentimos pero no puedes acceder a este 
			reto, te invitamos revises tu calendario de actividades<br>
			para ver la disponibilidad de los retos.</p>
			<p class="MsoNormal" style="text-align:justify;line-height:150%">
			&nbsp;</p>
			<p class="MsoNormal" style="text-align:justify;line-height:150%">
			&nbsp;</p>
